...
__global__ void clcuda_func_modifiers(
	int32_t const * __restrict__ var_A,
	int32_t const * __restrict__ var_B,
	int32_t * __restrict__ var_C,
...
KERNEL_LAUNCHER void clcuda_launcher_modifiers(
